...
inline double L1Norm (double *matrix, int mtxSize) {
	double l1norm=0.0;
...
inline void storeSimrankScore (double *matrix, int mtxSize) {
	ofstream saveNorm;
...
inline void simrankConfigInput (int &maxIterations, double &confidence) {
...
inline void debugInNeighbours (int *inNeighbours, int size) {
